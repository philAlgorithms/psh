...
/**
 * help_all - Displays all possible builtin program commands.
 */
void help_all(void)
{
	char *msg = "program\nThese shell commands are defined internally.\n";

	write(STDOUT_FILENO, msg, _stringlen(msg));
...
/**
 * help_alias - Displays information on the program builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the program builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the program builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the program builtin command 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible program builtin commands.\n";
